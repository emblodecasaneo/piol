...
// GET /api/subscriptions - Liste des abonnements actifs (admin)
...
// POST /api/subscriptions - Créer ou mettre à jour un abonnement pour un agent
...
// PUT /api/subscriptions/:id - Mettre à jour un abonnement existant
